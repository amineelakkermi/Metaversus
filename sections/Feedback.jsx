...
const Feedback = () => (
  ...
  className="flex-[0.5] lg:max-w-[370px] flex justify-end flex-col gradinet-05 sm:p-8
  p-7 rounded-[32px] border-[1px] border-[#6a6a6s]
  relative
  "
  >
    <div>
      ...
      ">Samantha</h4>
      <p className="mt-[8px] font-normal
      sm:text-[18px] text-[12px] sm:leading-[22px] leading-[16px] text-white
      ">Founded | Metaversus</p>
    </div>

    <p className="mt-[24px] font-normal
      sm:text-[24px] text-[18px] sm:leading-[45px] leading-[39px] text-white
      ">
